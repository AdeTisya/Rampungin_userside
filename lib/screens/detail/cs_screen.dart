...
import 'package:rampungin_id_userside/screens/detail/kategoribangunanmaster.dart';
import 'package:rampungin_id_userside/screens/detail/detail_order.dart';

class CsScreen extends KategoriBangunanMaster {
...
class _CsScreenState
    extends KategoriBangunanMasterState<CsScreen> {
  @override
  String getTitle() => 'Cleaning Service';
  ...
  List<Map<String, dynamic>> getItems() {
    return [
      {
        'name': 'Andi Pratama',
        'description': 'Service TV & Home Theater • 9 tahun • ⭐ 4.9 (156 review)',
        'icon': Icons.person,
