...
import 'package:rampungin_id_userside/screens/Login/login.dart';
...
class Setting extends StatelessWidget {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildSettingItem(
                                ...
                                onTap: () {
                                  logger.i('Privasi & Keamanan tapped');
                                },
                              ),
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _buildLanguageOption('Indonesia', true, context),
                _buildLanguageOption('English', false, context),
              ],
            ),
          ),
    );
  ...
  Widget _buildLanguageOption(
    ...
    return ListTile(
      title: Text(language),
      trailing:
          isSelected ? const Icon(Icons.check, color: Color(0xFFF3B950)) : null,
      onTap: () {
        Navigator.pop(context);
        // Handle language change
        logger.i('Bahasa dipilih: $language');
      },
    );
  }
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _buildNotificationOption('Notifikasi Pesan', true),
                _buildNotificationOption('Notifikasi Order', true),
                _buildNotificationOption('Notifikasi Promo', false),
                _buildNotificationOption('Notifikasi Sistem', true),
              ],
            ),
            actions: [
              TextButton(
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.pop(context);
                  logger.i('Pengaturan notifikasi disimpan');
                },
